...
<div class="main__content__container">
    <div class="side__menu {{ session('sidebarState') }}">
        ...
        <div class="side__menu__links">
            <ul>
                <li class="active"><a href="/service-record">Services</a></li>
                <li><a href="/service-record/create">New Services</a></li>
            </ul>
        </div>
    </div>
        ...
        <div class="content__body">
            <div class="content__body__item">
                <div class="sort__control sale">
                    <div class="sort__icon__wrapper">
                        ...
                        <div class="sort__icon">
                            <button class="sale_sort_btn" data-order="ASC"><i class="fa-solid fa-sort-up"></i></button>
                            <button class="sale_sort_btn" data-order="DESC"><i class="fa-solid fa-sort-down"></i></button>
                        </div>
                    </div>
                    <div class="sort__icon__wrapper">
                ...
                <div class="card__container__wrapper">
                    @include('_components.service.list')
                </div>
            </div>          
        </div>    
    </div>
