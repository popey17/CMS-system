                ...
                <div class="sort__control customer">
                    <div class="sort__icon__wrapper">
                        ...
                        <div class="sort__icon">
                            <button class="customer_sort_btn" data-order="ASC"><i class="fa-solid fa-sort-up"></i></button>
                            <button class="customer_sort_btn" data-order="DESC"><i class="fa-solid fa-sort-down"></i></button>
                        </div>
                    </div>
                    <div class="sort__icon__wrapper">
