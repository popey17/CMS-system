                        ...
                        <form method="POST" action="{{ route('customer.update',['id'=>$customer->id]) }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="">
                                        <input id="customer_id" type="tel" class="form-control @error('email') is-invalid @enderror" name="customer_id" value="{{$customer->customer_id}}">
                                    </div>
                                    @error('customer_id')
                                ...
                                <div class="col-md-6">
                                    <label for="created_date" class="col-md-4 col-form-label">{{ __('Date') }}</label>
                                        ...
                                        <div class="">
                                            <input id="created_date" type="date" class="form-control @error('created_date') is-invalid @enderror" name="created_date" value="{{ old('created_date', $customer->created_date) }}">
                                        </div>
                                        @error('created_date')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="">
                                        <input id="phone" type="tel" class="form-control @error('email') is-invalid @enderror" name="phone" value="{{ old('phone',$customer->phone) }}">
                                    </div>
                                    @error('phone')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="">
                                        <input id="gurdian_phone" type="tel" class="form-control @error('gurdian_phone') is-invalid @enderror" name="gurdian_phone" value="{{ old('gurdian_phone',$customer->gurdian_phone) }}">
                                    </div>
                                    @error('gurdian_phone')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="mb-3">
                                <div class="">
                                    ...
                                    <div class="">
                                        <textarea id="address" type="tel" class="form-control @error('address') is-invalid @enderror" name="address">{{old('address', $customer->address)}}</textarea>
                                    </div>
                                    @error('address')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
