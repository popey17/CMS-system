    ...
    <div id="app">
        ...
        <nav class="navBar">
            <a href="{{ url('/customer')}}" class="logo">
                <img src="{{ asset('img/company/logo.png') }}" alt="logo">
            </a>
            <div class="nav-links">
                <div class="top">
                    <ul>
                        ...
                        <li>
                            <div>
                                <a href="{{ url('/dashborad')}}" class="nav-item"><i class="fa-solid fa-chart-line"></i></a>
                            </div>
                        </li>
                        <li>
                            <div>
                        ...
                        <li>
                            <div>
                                <a href="{{ url('/contact')}}" class="nav-item"><i class="fa-solid fa-chart-line"></i></a>
                            </div>
                        </li>
                    </ul>
                </div>
